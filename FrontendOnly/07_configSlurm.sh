...
echo "y" | sacctmgr add account "ppgmmc posss pesq ict didatico" Description="User group" parent="cefetmg"
...
echo "y" | sacctmgr modify qos part30d set MaxSubmitJobs=1   MaxWall=31-0:0 Priority=1000
...
echo "y" | sacctmgr modify qos part12h set MaxSubmitJobs=50  MaxWall=12:00  Priority=1000
echo "y" | sacctmgr modify qos part6h  set MaxSubmitJobs=100 MaxWall=6:00   Priority=1000
